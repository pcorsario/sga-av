import { Bt as onUnmounted, Gn as reactive, It as onMounted, Ln as isReactive, Mt as onBeforeUnmount, N as Fragment, St as inject, Vn as markRaw, W as computed, Wt as provide, Xn as shallowRef, _n as watch, kt as nextTick, mt as h, o as createApp, qn as ref, rt as defineComponent, s as createSSRApp } from "./vue.runtime.esm-bundler-BoiyDnld.js";
...
function mergeWithDeep(target, source, merge, stack) {
	...
	for (let i = 0; i < sourceKeys.length; i++) {
		...
		if (typeof Buffer !== "undefined" && Buffer.isBuffer(sourceValue)) sourceValue = cloneDeep(sourceValue);
