        ...
        <div class="mb-8 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="font-medium text-zinc-500">
                    Inscribe a un padre de familia y asocia a sus hijos.
                </p>
            </div>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label
                            for="children"
                            class="mb-2 block text-sm font-bold text-zinc-900 dark:text-zinc-100"
                            >Asignar Estudiantes (Hijos)</label
                        >
                        <select
                            id="children"
                        ...
                        <p class="mt-2 text-xs text-zinc-500">
                            Mantén presionado CTRL (o CMD en Mac) para
                            seleccionar varios estudiantes a la vez.
                        </p>
                        <p
