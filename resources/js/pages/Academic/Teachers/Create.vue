    ...
    <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form @submit.prevent="submit"
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div class="space-y-6">
                    <div>
                        <label for="cedula"
                            class="mb-2 block text-sm font-bold text-zinc-900 dark:text-zinc-100">Cédula</label>
                        <input id="cedula" v-model="form.cedula" type="text" required placeholder="Ej. 1712345678"
                        ...
                        <p v-if="form.errors.cedula" class="mt-2 text-xs font-bold text-red-500">
                            {{ form.errors.cedula }}
                        </p>
                    </div>
                    <div>
                        <label for="name" class="mb-2 block text-sm font-bold text-zinc-900 dark:text-zinc-100">Nombre
                            Completo</label>
                        <input id="name" v-model="form.name" type="text" required placeholder="Ej. Ing. Juan Pérez"
                            class="w-full rounded-xl border-zinc-300 bg-white px-4 py-3 shadow-sm transition focus:ring-2 focus:ring-blue-500 dark:border-zinc-700 dark:bg-zinc-800"
                            :class="{ 'border-red-500': form.errors.name }" />
                        <p v-if="form.errors.name" class="mt-2 text-xs font-bold text-red-500">
                            {{ form.errors.name }}
                        </p>
                    </div>
                    ...
                    <div>
                        <label for="email" class="mb-2 block text-sm font-bold text-zinc-900 dark:text-zinc-100">Correo
                            Electrónico Institucional</label>
                        <input id="email" v-model="form.email" type="email" required placeholder="jperez@colegio.edu.ec"
                            class="w-full rounded-xl border-zinc-300 bg-white px-4 py-3 shadow-sm transition focus:ring-2 focus:ring-blue-500 dark:border-zinc-700 dark:bg-zinc-800"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="password"
                            class="mb-2 block text-sm font-bold text-zinc-900 dark:text-zinc-100">Contraseña Inicial
                            (Opcional)</label>
                    ...
                    <div>
                        <label for="password_confirmation"
                            class="mb-2 block text-sm font-bold text-zinc-900 dark:text-zinc-100">Confirmar
                            Contraseña</label>
        ...
        <div class="group mt-12">
            <div
                ...
                <div class="flex-1">
                    <h2 class="flex items-center gap-2 text-xl font-black text-zinc-900 dark:text-zinc-100">
                ...
                <div class="flex items-center gap-3">
                    <a :href="teachersRoutes.exportTemplate.url({
                        current_team: props.currentTeam?.slug ?? '',
                    })
                        "
                    ...
                    <label
                        ...
                        Importar Profesores
                        <input type="file" class="hidden" accept=".xlsx, .xls, .csv" @change="
                            (e: any) => {
            ...
            <div v-if="importForm.errors.file"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="mt-0.5 h-5 w-5 text-red-500" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path fill-rule="evenodd"
        ...
        <div v-if="isImporting"
            ...
            <div
                ...
                <div class="relative">
                    <div class="h-16 w-16 animate-spin rounded-full border-4 border-blue-500/20 border-t-blue-600">
                    </div>
