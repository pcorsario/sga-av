...
const submit = () => {
    form.put(teachersRoutes.update.url({ 
...
<template>
    ...
    <div class="px-4 py-8 mx-auto max-w-4xl sm:px-6 lg:px-8">
        <div class="mb-8 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-zinc-900 dark:text-zinc-50">Editar Profesor</h1>
                <p class="text-zinc-500 font-medium">Actualizar información y credenciales del docente.</p>
            </div>
        </div>
                ...
                <div class="space-y-6">
                    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-4 border border-blue-100 dark:border-blue-900/30">
                        <p class="text-xs text-blue-600 dark:text-blue-400 font-medium">
                            <span class="font-bold">Aviso:</span> Deja estos campos en blanco si no deseas cambiar la contraseña del maestro. Si la cambias, tendrá efecto inmediato.
                        </p>
                    </div>
